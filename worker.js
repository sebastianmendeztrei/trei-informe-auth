...
const ESCRITURACION_URL = "https://funnel-escrituracion.smendez.workers.dev/"; // TODO: actualizar cuando se mude a trei.cl
...
// Portal de informes: se muestra al entrar a la raíz. El botón "Entrar" agrega
// ?ir=1 para saltarse el portal y pasar directo al informe (ver más abajo).
...
// ══════════════════════════════════════════════════════════════════════════════
// PORTAL DE INFORMES — pantalla con 2 botones (Informe Comercial / Informe de
// Etapas de Escrituración), gateada por el mismo login de Entra ID. El estado
// de mantención se lee de maintenance.json (dentro de este mismo repo). El
// panel de salud actualiza ese archivo directo en GitHub cuando alguien mueve
...
<style>
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .top-header .msft { width:14px; height:14px; display:grid; grid-template-columns:1fr 1fr; gap:1px; flex-shrink:0; }
